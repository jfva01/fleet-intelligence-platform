...
export default function Modules() {
  return (
    <section id="Modules" className="py-24 bg-gradient-to-r from-slate-100 to-slate-50 dark:bg-gradient-to-r dark:from-slate-800 dark:to-slate-700 transition-colors duration-300">
        <Container>
            <div className="text-center max-w-3xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-400">
